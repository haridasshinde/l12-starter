        ...
        <div
            ...
            <main
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 rounded-t-lg bg-[url('/images/tmbill.png')] bg-cover bg-center shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:overflow-hidden lg:rounded-t-none lg:rounded-r-lg dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                    </div>
