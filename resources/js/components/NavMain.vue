                    ...
                    <SidebarMenuItem>
                        <CollapsibleTrigger as-child>
                            ...
                            >
                                ...
                                <span>{{ item.title }}</span>
                                <ChevronRight class="ml-auto transition-transform duration-500 group-data-[state=open]/collapsible:rotate-90" />
                            </SidebarMenuButton>
                        </CollapsibleTrigger>

                        <!-- 🎬 Animated collapsible content -->
                        <CollapsibleContent
                            class="overflow-hidden transition-all duration-600 data-[state=closed]:max-h-0 data-[state=closed]:opacity-0 data-[state=open]:max-h-40 data-[state=open]:opacity-100"
                        >
                            <SidebarMenuSub>
